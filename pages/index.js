...
export default function Home() {
  return (
    <div className="home">
      ...
      <Blocks>
        <Block title={['¿Sos', <strong>artista?</strong>]} button="Donar" link="">
          Unite a nuestro grupo de artistas y donanos tu obra para formar parte de este generoso proyecto.
        </Block>
        <Block title={['¿Querés', <strong>una obra?</strong>]} button="Comprar" link="">
